...
'''
# Get absolute path
label_path = os.path.abspath("class_labels.pkl")
print(f"Looking for class labels at: {label_path}")
...
if not os.path.exists(label_path):
    raise FileNotFoundError(f"Error: class_label.pkl not found at {label_path}")
...
class MainWindow(QMainWindow):
    def __init__(self, username=None):
        ...
        self.initUI()
        self.setWindowTitle ("AGRINOVA APP - Main Page")
    ...
    def initUI(self):
        ...
        self.ask_ai = QLabel('<a href="https://chat.openai.com/">Ask AI (AI सोध्नुहोस्)</a>', self)
        self.ask_ai.setTextFormat(Qt.RichText)
        self.ask_ai.setOpenExternalLinks(True)  # Enables hyperlink clicking
        self.ask_ai.setAlignment(Qt.AlignCenter)  # Centers text
        self.ask_ai.setStyleSheet("""
            background: qlineargradient(x1:0, y1:0, x2:1, y2:1, stop:0 #4CAF50, stop:1 #45a049);
    border-radius: 10px;
    color: white;
    padding: 5px;
""")
       ...
       # self.ask_ai.setIcon(QIcon(r"D:\HACKATHON real\ai_icon.png"))  # Replace with your icon path
        ...
        about_us_action = self.menu.addAction("About Me (मेरो बारेमा)")
        ...
        connect_label = QLabel("Connect with me (म संग जोड्नुहोस्):", self)
        ...
        social_media_links = QLabel("""
            <a href="https://www.facebook.com/manav.acharya.503/" style="color: #4CAF50; text-decoration: none;">Facebook</a> | 
            <a href="https://www.youtube.com" style="color: #4CAF50; text-decoration: none;">YouTube</a> | 
            <a href="https://www.tiktok.com" style="color: #4CAF50; text-decoration: none;">TikTok</a> | 
            <a href="https://x.com" style="color: #4CAF50; text-decoration: none;">Twitter</a> | 
        ...
        # Add FAQ button
        self.faq_button = QPushButton("FAQ (प्रश्नोत्तर)", self)
    ...
    def trainModel(self, folder_path):
        try:
            ...
            history = self.model.fit(train_generator, epochs=20)
            ...
            self.timer.stop()
            self.progress_bar.setVisible(False)
            QMessageBox.critical(self, "Error (त्रुटि)", f"An error occurred during training: {str(e)}")
